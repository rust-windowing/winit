...
use winit_core::event::{
    ...
    TabletToolData as CoreTabletToolData, TabletToolKind, WindowEvent,
};
    ...
    fn event(
        ...
        match event {
            ...
            ToolEvent::Rotation { degrees } => {
                data.tool_state.twist = Some(degrees.clamp(0., 360.) as u16);
            },
                    ...
                    let window_event = match event {
                        ...
                        TabletEvent::Button { button, state, serial } => {
                            ...
                            WindowEvent::PointerButton {
                                ...
                                position,
                                primary: true,
                                button: ButtonSource::TabletTool { kind, button },
                            }
                        },
