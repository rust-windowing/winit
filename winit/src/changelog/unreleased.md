...
- On Wayland, with resize increments: align from the requested minimum size instead of an internal `2x1`, round a surface smaller than one increment up to one, keep the alignment when an interactive resize ends, and ignore a zero increment instead of panicking.
