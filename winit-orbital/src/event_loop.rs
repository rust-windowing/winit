...
fn convert_scancode(scancode: u8) -> (PhysicalKey, Option<NamedKey>) {
    ...
    let (key_code, named_key_opt) = match scancode {
        ...
        orbclient::K_CTRL | orbclient::K_LEFT_CTRL => (KeyCode::ControlLeft, Some(NamedKey::Control)),
        orbclient::K_RIGHT_CTRL => (KeyCode::ControlRight, Some(NamedKey::Control)),
        ...
        orbclient::K_SUPER | orbclient::K_LEFT_SUPER => (KeyCode::MetaLeft, Some(NamedKey::Meta)),
