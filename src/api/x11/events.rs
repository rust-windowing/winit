...
pub fn keycode_to_element(scancode: libc::c_uint) -> Option<VirtualKeyCode> {
    Some(match scancode {
        ...
        ffi::XK_KP_Home => events::VirtualKeyCode::Numpad7,
        ffi::XK_KP_Left => events::VirtualKeyCode::Numpad4,
        ffi::XK_KP_Up => events::VirtualKeyCode::Numpad8,
        ffi::XK_KP_Right => events::VirtualKeyCode::Numpad6,
        ffi::XK_KP_Down => events::VirtualKeyCode::Numpad2,
        //ffi::XK_KP_Prior => events::VirtualKeyCode::Kp_prior,
        ffi::XK_KP_Page_Up => events::VirtualKeyCode::Numpad9,
        //ffi::XK_KP_Next => events::VirtualKeyCode::Kp_next,
        ffi::XK_KP_Page_Down => events::VirtualKeyCode::Numpad3,
        ffi::XK_KP_End => events::VirtualKeyCode::Numpad1,
        ffi::XK_KP_Begin => events::VirtualKeyCode::Numpad5,
        ffi::XK_KP_Insert => events::VirtualKeyCode::Numpad0,
