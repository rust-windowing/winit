...
use crate::{
    ...
    keyboard::{
        Action, Key, KeyCode, KeyLocation, ModifiersKeys, ModifiersState, NativeKey, NativeKeyCode,
        PhysicalKey,
    },
    platform::{
...
pub fn code_to_key(key: PhysicalKey, scancode: u16) -> Key {
    ...
    Key::Action(match code {
        KeyCode::Enter => Action::Enter,
        KeyCode::Tab => Action::Tab,
        KeyCode::Space => Action::Space,
        KeyCode::Backspace => Action::Backspace,
        KeyCode::Escape => Action::Escape,
        KeyCode::SuperRight => Action::Super,
        KeyCode::SuperLeft => Action::Super,
        KeyCode::ShiftLeft => Action::Shift,
        KeyCode::AltLeft => Action::Alt,
        KeyCode::ControlLeft => Action::Control,
        KeyCode::ShiftRight => Action::Shift,
        KeyCode::AltRight => Action::Alt,
        KeyCode::ControlRight => Action::Control,

        KeyCode::NumLock => Action::NumLock,
        KeyCode::AudioVolumeUp => Action::AudioVolumeUp,
        KeyCode::AudioVolumeDown => Action::AudioVolumeDown,

        // Other numpad keys all generate text on macOS (if I understand correctly)
        KeyCode::NumpadEnter => Action::Enter,

        KeyCode::F1 => Action::F1,
        KeyCode::F2 => Action::F2,
        KeyCode::F3 => Action::F3,
        KeyCode::F4 => Action::F4,
        KeyCode::F5 => Action::F5,
        KeyCode::F6 => Action::F6,
        KeyCode::F7 => Action::F7,
        KeyCode::F8 => Action::F8,
        KeyCode::F9 => Action::F9,
        KeyCode::F10 => Action::F10,
        KeyCode::F11 => Action::F11,
        KeyCode::F12 => Action::F12,
        KeyCode::F13 => Action::F13,
        KeyCode::F14 => Action::F14,
        KeyCode::F15 => Action::F15,
        KeyCode::F16 => Action::F16,
        KeyCode::F17 => Action::F17,
        KeyCode::F18 => Action::F18,
        KeyCode::F19 => Action::F19,
        KeyCode::F20 => Action::F20,
        ...
        KeyCode::ArrowLeft => Action::ArrowLeft,
        KeyCode::ArrowRight => Action::ArrowRight,
        KeyCode::ArrowDown => Action::ArrowDown,
        KeyCode::ArrowUp => Action::ArrowUp,
