...
// Map keysyms to VirtualKeyCodes, as defined in the X11 header files.
// Keys and their Shift+key equivalents are mapped to the same VirtualKeyCode
pub fn keysym_to_element(keysym: libc::c_uint) -> Option<VirtualKeyCode> {
    Some(match keysym {
        ...
        ffi::XK_Home | ffi::XK_KP_Home => VirtualKeyCode::Home,
        ffi::XK_Left | ffi::XK_KP_Left => VirtualKeyCode::Left,
        ffi::XK_Up | ffi::XK_KP_Up => VirtualKeyCode::Up,
        ffi::XK_Right | ffi::XK_KP_Right => VirtualKeyCode::Right,
        ffi::XK_Down | ffi::XK_KP_Down => VirtualKeyCode::Down,
        ffi::XK_Page_Up | ffi::XK_KP_Page_Up => VirtualKeyCode::PageUp,
        ffi::XK_Page_Down | ffi::XK_KP_Page_Down => VirtualKeyCode::PageDown,
        ffi::XK_End | ffi::XK_KP_End => VirtualKeyCode::End,
        ffi::XK_Insert | ffi::XK_KP_Insert => VirtualKeyCode::Insert,
        ...
        ffi::XK_grave | ffi::XK_asciitilde => VirtualKeyCode::Grave,
        ffi::XK_0 | ffi::XK_parenright => VirtualKeyCode::Key0,
        ffi::XK_1 | ffi::XK_exclam => VirtualKeyCode::Key1,
        ffi::XK_2 | ffi::XK_at => VirtualKeyCode::Key2,
        ffi::XK_3 | ffi::XK_numbersign => VirtualKeyCode::Key3,
        ffi::XK_4 | ffi::XK_dollar => VirtualKeyCode::Key4,
        ffi::XK_5 | ffi::XK_percent => VirtualKeyCode::Key5,
        ffi::XK_6 | ffi::XK_asciicircum => VirtualKeyCode::Key6,
        ffi::XK_7 | ffi::XK_ampersand => VirtualKeyCode::Key7,
        ffi::XK_8 | ffi::XK_asterisk => VirtualKeyCode::Key8,
        ffi::XK_9 | ffi::XK_parenleft => VirtualKeyCode::Key9,
        ffi::XK_minus | ffi::XK_underscore => VirtualKeyCode::Minus,
        ffi::XK_equal | ffi::XK_plus => VirtualKeyCode::Equals,
        ffi::XK_backslash | ffi::XK_bar => VirtualKeyCode::Backslash,
        ffi::XK_bracketleft | ffi::XK_braceleft => VirtualKeyCode::LBracket,
        ffi::XK_bracketright | ffi::XK_braceright => VirtualKeyCode::RBracket,
        ffi::XK_semicolon | ffi::XK_colon => VirtualKeyCode::Semicolon,
        ffi::XK_apostrophe | ffi::XK_quotedbl => VirtualKeyCode::Apostrophe,
        ffi::XK_comma | ffi::XK_less => VirtualKeyCode::Comma,
        ffi::XK_period | ffi::XK_greater => VirtualKeyCode::Period,
        ffi::XK_slash | ffi::XK_question => VirtualKeyCode::Slash,
        ffi::XK_A | ffi::XK_a => VirtualKeyCode::A,
        ffi::XK_B | ffi::XK_b => VirtualKeyCode::B,
        ffi::XK_C | ffi::XK_c => VirtualKeyCode::C,
        ffi::XK_D | ffi::XK_d => VirtualKeyCode::D,
        ffi::XK_E | ffi::XK_e => VirtualKeyCode::E,
        ffi::XK_F | ffi::XK_f => VirtualKeyCode::F,
        ffi::XK_G | ffi::XK_g => VirtualKeyCode::G,
        ffi::XK_H | ffi::XK_h => VirtualKeyCode::H,
        ffi::XK_I | ffi::XK_i => VirtualKeyCode::I,
        ffi::XK_J | ffi::XK_j => VirtualKeyCode::J,
        ffi::XK_K | ffi::XK_k => VirtualKeyCode::K,
        ffi::XK_L | ffi::XK_l => VirtualKeyCode::L,
        ffi::XK_M | ffi::XK_m => VirtualKeyCode::M,
        ffi::XK_N | ffi::XK_n => VirtualKeyCode::N,
        ffi::XK_O | ffi::XK_o => VirtualKeyCode::O,
        ffi::XK_P | ffi::XK_p => VirtualKeyCode::P,
        ffi::XK_Q | ffi::XK_q => VirtualKeyCode::Q,
        ffi::XK_R | ffi::XK_r => VirtualKeyCode::R,
        ffi::XK_S | ffi::XK_s => VirtualKeyCode::S,
        ffi::XK_T | ffi::XK_t => VirtualKeyCode::T,
        ffi::XK_U | ffi::XK_u => VirtualKeyCode::U,
        ffi::XK_V | ffi::XK_v => VirtualKeyCode::V,
        ffi::XK_W | ffi::XK_w => VirtualKeyCode::W,
        ffi::XK_X | ffi::XK_x => VirtualKeyCode::X,
        ffi::XK_Y | ffi::XK_y => VirtualKeyCode::Y,
        ffi::XK_Z | ffi::XK_z => VirtualKeyCode::Z,
