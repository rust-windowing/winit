...
impl VirtualKeyCode {
    pub fn into_char(self, shift: bool) -> Option<char> {
        match (self, shift) {
            ...
            (VirtualKeyCode::A, true) => Some('A'),
            (VirtualKeyCode::B, false) => Some('b'),
            (VirtualKeyCode::B, true) => Some('B'),
            (VirtualKeyCode::C, false) => Some('c'),
            (VirtualKeyCode::C, true) => Some('C'),
            (VirtualKeyCode::D, false) => Some('d'),
            (VirtualKeyCode::D, true) => Some('D'),
            (VirtualKeyCode::E, false) => Some('e'),
            (VirtualKeyCode::E, true) => Some('E'),
            (VirtualKeyCode::F, false) => Some('f'),
            (VirtualKeyCode::F, true) => Some('F'),
            (VirtualKeyCode::G, false) => Some('g'),
            (VirtualKeyCode::G, true) => Some('G'),
            (VirtualKeyCode::H, false) => Some('h'),
            (VirtualKeyCode::H, true) => Some('H'),
            (VirtualKeyCode::I, false) => Some('i'),
            (VirtualKeyCode::I, true) => Some('I'),
            (VirtualKeyCode::J, false) => Some('j'),
            (VirtualKeyCode::J, true) => Some('J'),
            (VirtualKeyCode::K, false) => Some('k'),
            (VirtualKeyCode::K, true) => Some('K'),
            (VirtualKeyCode::L, false) => Some('l'),
            (VirtualKeyCode::L, true) => Some('L'),
            (VirtualKeyCode::M, false) => Some('m'),
            (VirtualKeyCode::M, true) => Some('M'),
            (VirtualKeyCode::N, false) => Some('n'),
            (VirtualKeyCode::N, true) => Some('N'),
            (VirtualKeyCode::O, false) => Some('o'),
            (VirtualKeyCode::O, true) => Some('O'),
            (VirtualKeyCode::P, false) => Some('p'),
            (VirtualKeyCode::P, true) => Some('P'),
            (VirtualKeyCode::Q, false) => Some('q'),
            (VirtualKeyCode::Q, true) => Some('Q'),
            (VirtualKeyCode::R, false) => Some('r'),
            (VirtualKeyCode::R, true) => Some('R'),
            (VirtualKeyCode::S, false) => Some('s'),
            (VirtualKeyCode::S, true) => Some('S'),
            (VirtualKeyCode::T, false) => Some('t'),
            (VirtualKeyCode::T, true) => Some('T'),
            (VirtualKeyCode::U, false) => Some('u'),
            (VirtualKeyCode::U, true) => Some('U'),
            (VirtualKeyCode::V, false) => Some('v'),
            (VirtualKeyCode::V, true) => Some('V'),
            (VirtualKeyCode::W, false) => Some('w'),
            (VirtualKeyCode::W, true) => Some('W'),
            (VirtualKeyCode::X, false) => Some('x'),
            (VirtualKeyCode::X, true) => Some('X'),
            (VirtualKeyCode::Y, false) => Some('y'),
            (VirtualKeyCode::Y, true) => Some('Y'),
            (VirtualKeyCode::Z, false) => Some('z'),
            (VirtualKeyCode::Z, true) => Some('Z'),
            (VirtualKeyCode::Return, false) => Some('\n'),
            (VirtualKeyCode::Return, true) => Some('\n'),
            (VirtualKeyCode::Space, false) => Some(' '),
            (VirtualKeyCode::Space, true) => Some(' '),
            (VirtualKeyCode::Caret, false) => Some('^'),
            (VirtualKeyCode::Caret, true) => Some('^'),
            (VirtualKeyCode::Numpad0, false) => Some('0'),
            (VirtualKeyCode::Numpad0, true) => Some('0'),
            (VirtualKeyCode::Numpad1, false) => Some('1'),
            (VirtualKeyCode::Numpad1, true) => Some('1'),
            (VirtualKeyCode::Numpad2, false) => Some('2'),
            (VirtualKeyCode::Numpad2, true) => Some('2'),
            (VirtualKeyCode::Numpad3, false) => Some('3'),
            (VirtualKeyCode::Numpad3, true) => Some('3'),
            (VirtualKeyCode::Numpad4, false) => Some('4'),
            (VirtualKeyCode::Numpad4, true) => Some('4'),
            (VirtualKeyCode::Numpad5, false) => Some('5'),
            (VirtualKeyCode::Numpad5, true) => Some('5'),
            (VirtualKeyCode::Numpad6, false) => Some('6'),
            (VirtualKeyCode::Numpad6, true) => Some('6'),
            (VirtualKeyCode::Numpad7, false) => Some('7'),
            (VirtualKeyCode::Numpad7, true) => Some('7'),
            (VirtualKeyCode::Numpad8, false) => Some('8'),
            (VirtualKeyCode::Numpad8, true) => Some('8'),
            (VirtualKeyCode::Numpad9, false) => Some('9'),
            (VirtualKeyCode::Numpad9, true) => Some('9'),
            (VirtualKeyCode::NumpadAdd, false) => Some('+'),
            (VirtualKeyCode::NumpadAdd, true) => Some('+'),
            (VirtualKeyCode::NumpadDivide, false) => Some('/'),
            (VirtualKeyCode::NumpadDivide, true) => Some('/'),
            (VirtualKeyCode::NumpadDecimal, false) => Some('.'),
            (VirtualKeyCode::NumpadDecimal, true) => Some('.'),
            (VirtualKeyCode::NumpadComma, false) => Some(','),
            (VirtualKeyCode::NumpadComma, true) => Some(','),
            (VirtualKeyCode::NumpadEnter, false) => Some('\n'),
            (VirtualKeyCode::NumpadEnter, true) => Some('\n'),
            (VirtualKeyCode::NumpadEquals, false) => Some('='),
            (VirtualKeyCode::NumpadEquals, true) => Some('='),
            (VirtualKeyCode::NumpadMultiply, false) => Some('*'),
            (VirtualKeyCode::NumpadMultiply, true) => Some('*'),
            (VirtualKeyCode::NumpadSubtract, false) => Some('-'),
            (VirtualKeyCode::NumpadSubtract, true) => Some('-'),
            (VirtualKeyCode::Apostrophe, false) => Some('\''),
            (VirtualKeyCode::Apostrophe, true) => Some('"'),
            (VirtualKeyCode::Asterisk, false) => Some('*'),
            (VirtualKeyCode::Asterisk, true) => Some('*'),
            (VirtualKeyCode::Backslash, false) => Some('\\'),
            (VirtualKeyCode::Backslash, true) => Some('|'),
            (VirtualKeyCode::Colon, false) => Some(':'),
            (VirtualKeyCode::Colon, true) => Some(':'),
            ...
            (VirtualKeyCode::Grave, false) => Some('`'),
            (VirtualKeyCode::Grave, true) => Some('~'),
            ...
            (VirtualKeyCode::Plus, false) => Some('+'),
            (VirtualKeyCode::Plus, true) => Some('+'),
            ...
            (VirtualKeyCode::Tab, false) => Some('\t'),
            (VirtualKeyCode::Tab, true) => Some('\t'),
            _ => None,
        }
    }
}
