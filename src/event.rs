...
impl TryInto<char> for VirtualKeyCode {
    type Error = ();
    fn try_into(self) -> Result<char, Self::Error> {
        match self {
            ...
            VirtualKeyCode::Return => Ok('\n'),
            VirtualKeyCode::Space => Ok(' '),
            VirtualKeyCode::Caret => Ok('^'),
            VirtualKeyCode::Numpad0 => Ok('0'),
            VirtualKeyCode::Numpad1 => Ok('1'),
            VirtualKeyCode::Numpad2 => Ok('2'),
            VirtualKeyCode::Numpad3 => Ok('3'),
            VirtualKeyCode::Numpad4 => Ok('4'),
            VirtualKeyCode::Numpad5 => Ok('5'),
            VirtualKeyCode::Numpad6 => Ok('6'),
            VirtualKeyCode::Numpad7 => Ok('7'),
            VirtualKeyCode::Numpad8 => Ok('8'),
            VirtualKeyCode::Numpad9 => Ok('9'),
            VirtualKeyCode::NumpadAdd => Ok('+'),
            VirtualKeyCode::NumpadDivide => Ok('/'),
            VirtualKeyCode::NumpadDecimal => Ok('.'),
            VirtualKeyCode::NumpadComma => Ok(','),
            VirtualKeyCode::NumpadEnter => Ok('\n'),
            VirtualKeyCode::NumpadEquals => Ok('='),
            VirtualKeyCode::NumpadMultiply => Ok('*'),
            VirtualKeyCode::NumpadSubtract => Ok('-'),
            VirtualKeyCode::Apostrophe => Ok('\''),
            VirtualKeyCode::Asterisk => Ok('*'),
            VirtualKeyCode::Backslash => Ok('\\'),
            VirtualKeyCode::Colon => Ok(';'),
            VirtualKeyCode::Comma => Ok(','),
            VirtualKeyCode::Equals => Ok('='),
            VirtualKeyCode::Grave => Ok('`'),
            VirtualKeyCode::LBracket => Ok('['),
            VirtualKeyCode::Minus => Ok('-'),
            VirtualKeyCode::Period => Ok('.'),
            VirtualKeyCode::Plus => Ok('+'),
            VirtualKeyCode::RBracket => Ok(']'),
            VirtualKeyCode::Semicolon => Ok(';'),
            VirtualKeyCode::Slash => Ok('/'),
            VirtualKeyCode::Tab => Ok('\t'),
            _ => Err(()),
        }
    }
}
