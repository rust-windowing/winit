...
pub trait EventLoopExtPumpEvents {
    ...
    ///   crates like `rfd` that inspect [`-[NSApplication isRunning]`].
    ///
    /// [`WindowEvent::RedrawRequested`]: crate::event::WindowEvent::RedrawRequested
    /// [`-[NSApplication isRunning]`]: https://developer.apple.com/documentation/appkit/nsapplication/isrunning?language=objc
