...
// particular, the variant names within `Key` and their documentation are modified versions of
// contents of the aforementioned specification.
//
...
// the W3C short notice apply to the `Key` enums and their variants and the documentation attached
// to their variants.
