...
fn main() {
    ...
    let cursors = [MouseCursor::Default,
    ...
    events_loop.run_forever(|event| match event {
        Event::WindowEvent {
            event: WindowEvent::KeyboardInput(ElementState::Pressed, _, _), ..
        } => {
        ...
        Event::WindowEvent { event: WindowEvent::Closed, .. } => events_loop.interrupt(),
        _ => (),
    });
}
